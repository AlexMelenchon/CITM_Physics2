...
public:
	...
	bool CleanUp();
	p2List<BodyPointer> circlelist;

	// TODO 4: Move body creation to 3 functions to create circles, rectangles and chains

	BodyPointer CreateCircle(int mouseX, int mouseY, int diameter);

	void CreateVox(int mouseX, int mouseY);


	void CreateRick(int mouseX, int mouseY);
