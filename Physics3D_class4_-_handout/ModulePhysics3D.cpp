...
bool ModulePhysics3D::CleanUp()
{
	...
	{
		btTypedConstraint* obj = world->getConstraint(i);
...
{
	btPoint2PointConstraint* p2pconstr = new btPoint2PointConstraint(*bodyA.body.GetBody(), *bodyB.body.GetBody(), pivotInA, pivotInB);


	world->addConstraint(p2pconstr);
